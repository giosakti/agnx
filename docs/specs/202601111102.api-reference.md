...
# Response shows work completed
{
  ...
  "data": {
    ...
    "on_disconnect": "continue",
    "messages_count": 47,
    "last_activity": "2025-01-24T11:30:00Z"
  },
  "request_id": "req_def456"
}
...
# Detach from a session (state preserved, behavior depends on on_disconnect setting)
curl -X POST http://localhost:8080/api/v1/sessions/session_abc123/detach

# Attach to an existing session
curl -X POST http://localhost:8080/api/v1/sessions/session_def456/attach

# End a session (archives state)
